...
if (get_option('kleverlist_service_type') === KLEVERLIST_SERVICE_AWEBER) {
    $title = esc_html__('Global Settings - Tags Management for AWeber', 'kleverlist');
    $description = esc_html__('On this page, you can choose which tags will be synchronized between WooCommerce and AWeber. Tags are labels you assign to your contacts to categorize them based on certain characteristics or interactions. Unlike fields, tags are more flexible and can be added or removed as needed. Tags are used to track and segment contacts based on their behavior, interests, or engagement with your brand.', 'kleverlist');
}
?>
<div class="kleverlist-mapping-page kleverlist-setting-page kleverlist-setting-top-area">
    ...
    <div id="kleverlist_mapping_settings_content" class="kleverlist-mapping-content">
            ...
            <div class="kleverlist-settings-top-section">
                ...
                <div class="kleverlist-settings-top-description">
                    <p class="kleverlist-page-main-description"><?php echo esc_html($description);?>
                        <a href="https://kleverlist.com/docs/config/tags-aweber/" target="_blank">
        ...
        <div class="klever-list-settings-main">
            <form method="post" id="kleverlist_aweber_tags_settings">  
                        ...
                        <table class="form-table width-900">                       
                                ...
                                <tr>
                                    ...
                                    <td>          
                                        <div class="kleverlist-container">
                                            <label class="kleverlist-switch" for="kleverlist_aweber_order_processing_tag">
                                                <input type="checkbox" name="kleverlist_aweber_order_processing_tag" class="kleverlist-mapping-checkbox" id="kleverlist_aweber_order_processing_tag" <?php checked('1' === get_option('kleverlist_aweber_order_processing_tag'));?> value="1" />
                            ...
                            <tbody class="kleverlist-free-option">
                                <tr>
                                    ...
                                    <td>          
                                        <div class="kleverlist-container">
                                            <label class="kleverlist-switch" for="kleverlist_aweber_order_completed_tag">
                                                <input type="checkbox" name="kleverlist_aweber_order_completed_tag" class="kleverlist-mapping-checkbox" id="kleverlist_aweber_order_completed_tag" <?php checked('1' === get_option('kleverlist_aweber_order_completed_tag'));?> value="1" />
                                                <div class="kleverlist-slider kleverlist-round"></div>
                                            </label>
                                        </div>
                                        ...
                                        <div class="kleverlist-aweber-remove-order-processing-tag-section <?php echo ( esc_attr(get_option('kleverlist_aweber_order_completed_tag')) === '1') ? 'show-input': 'hide-input'?>">
                                            <div class="kleverlist-free-option">
                                                <div class="kleverlist-toggle-options kleverlist-sendy-remove-order-processing-tag-input">
                                                    <div class="kleverlist-aweber-pro-input-block">
                                                        <label for="kleverlist_aweber_remove_order_processing_tag">
                                                            <input type="checkbox" id="kleverlist_aweber_remove_order_processing_tag" name="kleverlist_aweber_remove_order_processing_tag" <?php checked('1' === get_option('kleverlist_aweber_remove_order_processing_tag', ''));?> value="yes">
                                                        <span><strong><?php esc_html_e('Remove Order Processing Tag', 'kleverlist');?></strong></span>
                                                        </label>
                                                    </div>
                                                </div>      
                                                <p class="kleverlist-data kleverlist-aweber-toggle-text">
                            ...
                            <tbody class="kleverlist-premium-option <?php echo esc_attr(KLEVERLIST_PLUGIN_CLASS)?>">
                                ...
                                <tr>
                                    ...
                                    <td class="kleverlist-global-help-info">   
                                        <div class="kleverlist-container">
                                            <label class="kleverlist-switch" for="klerverlist_aweber_product_tag_allow">
                                                <input type="checkbox" name="klerverlist_aweber_product_tag_allow" id="klerverlist_aweber_product_tag_allow" <?php checked('1' === get_option('klerverlist_aweber_product_tag_allow') && KLEVERLIST_PLUGIN_PLAN === 'kleverlist-primium');?> class="kleverlist-global-checkbox" value="1" />
                                                <div class="kleverlist-slider kleverlist-round"></div>
                                            </label>
                                        </div>                          
                            ...
                            <tbody class="kleverlist-data-mapping-bg kleverlist-margin">
                                <tr>
                                    ...
                                    <td class="kleverlist-position button-mapping">
                                        <?php
                                            $button_attributes = array( 'id' => 'kleverlist_aweber_tag_settings_save' );
