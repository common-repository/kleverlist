...
if (get_option('kleverlist_service_type') === KLEVERLIST_SERVICE_MAILCHIMP) {
    $title = esc_html__('Global Settings - Tags Management for Mailchimp', 'kleverlist');
    $description = esc_html__('On this page, you can choose which tags will be synchronized between WooCommerce and Mailchimp. Tags are labels you assign to your contacts to categorize them based on certain characteristics or interactions. Unlike fields, tags are more flexible and can be added or removed as needed. Tags are used to track and segment contacts based on their behavior, interests, or engagement with your brand.', 'kleverlist');
}
?>
<div class="kleverlist-mapping-page kleverlist-setting-page kleverlist-setting-top-area">
    ...
    <div id="kleverlist_mapping_settings_content" class="kleverlist-mapping-content">
            ...
            <div class="kleverlist-settings-top-section">
                ...
                <div class="kleverlist-settings-top-description">
                    <p class="kleverlist-page-main-description"><?php echo esc_html($description);?>
                        <a href="https://kleverlist.com/docs/config/tags-mailchimp/" target="_blank">
        ...
        <div class="klever-list-settings-main">
            <form method="post" id="kleverlist_mailchimp_tags_settings">  
                        ...
                        <table class="form-table width-900">                       
                            <tbody class="kleverlist-free-option">
                                <tr>
                                    ...
                                    <td class="klever-list-data-mappinng-page-heading">
                                        <div>                                    
                                            <h4><?php esc_html_e('Choose whether to enable / disable the default tags.', 'kleverlist');?></h4>
                                        </div>
                                    </td>
                                </tr>  
                            </tbody>
                                ...
                                <tr>
                                    ...
                                    <td>          
                                        <div class="kleverlist-container">
                                            <label class="kleverlist-switch" for="kleverlist_mailchimp_order_processing">
                                                <input type="checkbox" name="kleverlist_mailchimp_order_processing" class="kleverlist-mapping-checkbox" id="kleverlist_mailchimp_order_processing" <?php checked('1' === get_option('kleverlist_mailchimp_order_processing'));?> value="1" />
                                        ...
                                        <div class="kleverlist-tooltip kleverlist-tooltip-box">
                                            ...
                                            <span class="kleverlist-tooltiptext">
                                                <?php esc_html_e('Tag will be created automatically if it does not exist.', 'kleverlist');?>
                                            </span>
                                        </div>        
                            ...
                            <tbody class="kleverlist-free-option">
                                <tr>
                                    ...
                                    <td>          
                                        <div class="kleverlist-container">
                                            <label class="kleverlist-switch" for="kleverlist_mailchimp_order_completed">
                                                <input type="checkbox" name="kleverlist_mailchimp_order_completed" class="kleverlist-mapping-checkbox" id="kleverlist_mailchimp_order_completed" <?php checked('1' === get_option('kleverlist_mailchimp_order_completed'));?> value="1" />
                                                <div class="kleverlist-slider kleverlist-round"></div>
                                            </label>
                                        </div>
                                        <div class="kleverlist-tooltip kleverlist-tooltip-box">
                                        ...
                                        <div class="kleverlist-mailchimp-remove-order-processing-tag-section <?php echo ( esc_attr(get_option('kleverlist_mailchimp_order_completed')) === '1') ? 'show-input': 'hide-input'?>">
                                            <div class="kleverlist-free-option">
                                                <div class="kleverlist-toggle-options kleverlist-mailchimp-remove-order-processing-tag-input">
                                                    <div class="kleverlist-mailchimp-pro-input-block">
                                                        <label for="kleverlist_mailchimp_remove_order_processing_tag">
                                                            <input type="checkbox" id="kleverlist_mailchimp_remove_order_processing_tag" name="kleverlist_mailchimp_remove_order_processing_tag" <?php checked('1' === get_option('kleverlist_mailchimp_remove_order_processing_tag', ''));?> value="yes">
                                                        <span><strong><?php esc_html_e('Remove Order Processing Tag', 'kleverlist');?></strong></span>
                                                        </label>
                                                    </div>
                                                </div>      
                                                <p class="kleverlist-data kleverlist-mailchimp-toggle-text">
                        ...
                        <table class="form-table width-900">
                            <tbody class="kleverlist-free-option">
                                <tr>
                                    ...
                                    <td class="klever-list-data-mappinng-page-heading">
                                        <div>                                    
                                            <h4><?php esc_html_e('Choose whether to enable / disable product tags synchronization.', 'kleverlist');?></h4>
                                        </div>
                                    </td>
                                </tr>  
                            </tbody>
                            <tbody class="kleverlist-premium-option <?php echo esc_attr(KLEVERLIST_PLUGIN_CLASS)?>">
                                <tr>
                                    ...
                                    <td class="kleverlist-global-help-info">   
                                        <div class="kleverlist-container">
                                            <label class="kleverlist-switch" for="klerverlist_mailchimp_product_tag_allow">
                                                <input type="checkbox" name="klerverlist_mailchimp_product_tag_allow" id="klerverlist_mailchimp_product_tag_allow" <?php checked('1' === get_option('klerverlist_mailchimp_product_tag_allow') && KLEVERLIST_PLUGIN_PLAN === 'kleverlist-primium');?> class="kleverlist-global-checkbox" value="1" />
                                                <div class="kleverlist-slider kleverlist-round"></div>
                                            </label>
                                        </div>                          
                                        ...
                                        <div class="kleverlist-tooltip kleverlist-tooltip-box">
                                            <span class="dashicons dashicons-editor-help"></span>
                                            <span class="kleverlist-tooltiptext">
                                                <?php esc_html_e('Product Tags can be created on “Products → Tags” page.', 'kleverlist');?>
                                            </span>
                                        </div>        
                                        <p class="kleverlist-maapping-subheading">
                                            <?php
                                            printf(
                                                esc_html__('If %1$senabled%2$s, tags associated to a product will be added to the customer contact, only for the product(s) in which the integration is active.', 'kleverlist'),
                                                '<strong>',
                                                '</strong>'
                                            );
                                            ?>      
                            ...
                            <tbody class="kleverlist-data-mapping-bg kleverlist-margin">
                                <tr>
                                    ...
                                    <td class="kleverlist-position button-mapping">
                                        <?php
                                            $button_attributes = array( 'id' => 'kleverlist_mailchimp_tag_settings_save' );
